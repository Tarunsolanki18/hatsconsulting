...
(function () {
    ...
    const uploadProof = async (userId, file) => {
      try {
        ...
        // Try to upload to 'proofs' bucket, but use base64 as primary method
        console.log('Using base64 storage method for better compatibility...');
        
        // Convert file to base64 (more reliable than Supabase storage)
        ...
        // Note: Supabase storage disabled due to bucket configuration issues
        // Using base64 method which works reliably without server setup
